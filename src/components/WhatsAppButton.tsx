  ...
  if (variant === "floating") {
    return (
      <a
        ...
        className="hidden lg:flex fixed bottom-6 right-6 z-40 items-center gap-2 bg-[#25D366] hover:bg-[#20ba5a] text-white px-4 py-2.5 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 group font-medium text-xs"
      >
