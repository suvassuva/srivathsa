        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-brand-red flex items-center justify-center font-extrabold text-white text-xl shadow-md">
                SE
              </div>
              <div>
                <span className="font-black text-white text-xl tracking-wide block uppercase">
                  {COMPANY_INFO.name}
                </span>
            ...
            {/* Leadership box */}
            <div className="p-4 rounded-xl bg-slate-800/70 border border-slate-700/80 max-w-md flex items-center justify-between">
              <div>
              ...
              <div className="flex items-center gap-1 text-xs text-red-400 font-bold bg-red-950/60 px-2.5 py-1 rounded border border-red-800/50">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-xs font-bold uppercase tracking-widest text-red-400">
              Quick Links
            </h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                ...
                >
                  <Phone className="w-4 h-4 text-red-400 mt-1 shrink-0" />
                  <div>
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 hover:text-white transition-colors"
                >
                  <Mail className="w-4 h-4 text-red-400 mt-1 shrink-0" />
                  <div>
