...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800 pt-8 pb-16 sm:pt-12 sm:pb-20 lg:pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 pb-6 sm:pb-10 border-b border-slate-800">
          {/* Col 1 & 2: Branding & Leadership */}
          <div className="lg:col-span-2 space-y-3 sm:space-y-5">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-md bg-brand-red flex items-center justify-center font-black text-white text-xs sm:text-sm shadow-md shrink-0">
                SE
              </div>
              <div>
                <span className="font-black text-white text-sm sm:text-base tracking-wide block uppercase">
                  {COMPANY_INFO.name}
                </span>
                <span className="text-[9.5px] sm:text-[10.5px] text-red-400 font-bold tracking-wider uppercase block">
            ...
            {/* Leadership box */}
            <div className="p-3 rounded-lg bg-slate-800/70 border border-slate-700/80 max-w-md flex items-center justify-between gap-2 shadow-2xs">
              <div>
                <span className="text-[9.5px] sm:text-[10.5px] text-slate-400 uppercase tracking-widest block font-medium">
                  Founder & CEO
                </span>
                <span className="font-extrabold text-white text-xs sm:text-xs">
                  {COMPANY_INFO.ceo.name}
                </span>
              </div>
              <div className="flex items-center gap-1 text-[9.5px] sm:text-[10.5px] text-red-400 font-bold bg-red-950/60 px-2 py-0.5 rounded border border-red-800/50 shrink-0">
          ...
          <div className="space-y-2.5 sm:space-y-3.5">
            <h3 className="text-white text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-red-400">
              Quick Links
            </h3>
          ...
          <div className="space-y-2.5 sm:space-y-3.5">
            ...
            <ul className="space-y-2 sm:space-y-2.5 text-xs">
              <li>
                <Link
                  href="/signage"
                  className="hover:text-white transition-colors font-bold text-white block text-xs"
                >
        ...
        <div className="pt-5 sm:pt-6 flex flex-col sm:flex-row items-center justify-between gap-2.5 text-[10.5px] sm:text-xs text-slate-400">
